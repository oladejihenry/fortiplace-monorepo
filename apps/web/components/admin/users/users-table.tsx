    ...
    try {
      ...
      if (error instanceof AxiosError) {
        if (error.response?.status === 403) {
          toast.error(
            error.response.data.message || "You are not authorized to update this user's role",
          )
        } else {
            ...
            sortedUsers.map((user: UserData) => (
              <TableRow key={user.id} className="hover:bg-muted/50">
                <TableCell className="hidden py-4 md:table-cell">
                  <div className="bg-muted ml-2 flex h-12 w-12 items-center justify-center overflow-hidden rounded-full">
                ...
                <TableCell className="hidden md:table-cell">
                  <Badge variant={isBanned(user) ? 'destructive' : 'default'}>
                ...
                <TableCell className="text-right">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem
                        onClick={() =>
                          isBanned(user) ? handleUnban(user.id) : openBanModal(user.id)
                        }
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This action cannot be undone. This will permanently disable payouts
                              for the user.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
      ...
      <Dialog open={banModalOpen} onOpenChange={setBanModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide a reason for banning this user. This information will be stored for
