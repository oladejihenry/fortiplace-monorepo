    ...
    <div className="space-y-6">
      ...
      <Dialog open={open} onOpenChange={handleOpenChange}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>{selectedCampaign ? 'Edit' : 'Create'} Email Campaign</DialogTitle>
            <DialogDescription>
              {selectedCampaign ? 'Edit your' : 'Create a new'} email campaign to send to your
              users.
            </DialogDescription>
          </DialogHeader>
          <EmailCampaignForm
      ...
      <EmailCampaignsTable campaigns={campaigns} onDelete={handleDelete} />
