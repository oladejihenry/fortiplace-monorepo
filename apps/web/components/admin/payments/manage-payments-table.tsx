                ...
                <TableBody>
                    {payments?.data.map((payment) => (
                        <TableRow key={payment.id} className="hover:bg-muted/50">
                            ...
                            <TableCell className="hidden md:table-cell">{formatPrice(payment.amount, payment.currency || 'NGN')}</TableCell>
                            <TableCell className="hidden md:table-cell">{format(new Date(payment.created_at), "PPP")}</TableCell>
